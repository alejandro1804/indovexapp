...
class _PagosScreenState extends State<PagosScreen> {
  ...
  Future<void> _cargar() async {
    ...
    try {
      // Trae todos los pagos; el filtrado por vista se hace en el cliente
      // para poder alternar entre pestañas sin volver a consultar.
  ...
  String _montoFmt(dynamic monto) {
    ...
    if (m == null) return '—';
    // Formato simple con separador de miles y 2 decimales
