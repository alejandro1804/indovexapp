-- ============================================================================
-- Fix: sa_purgar_datos_empresa referenciaba la tabla vieja "encargado_sector"
-- que fue renombrada/generalizada a "usuario_sector". Esto hacía fallar la
-- purga con: relation "encargado_sector" does not exist (borrados: 0).
--
-- Cambios respecto a la versión anterior:
--   1. encargado_sector -> usuario_sector.
--   2. usuario_sector se borra ANTES de maquinas/sectores/usuarios, ya que
--      tiene FK a usuarios y a sectores (evita fallo por FK).
--   3. Se agrega SET search_path = public para blindar el contexto de esquema.
-- ============================================================================
